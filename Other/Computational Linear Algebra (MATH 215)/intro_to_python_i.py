# -*- coding: utf-8 -*-
"""Intro_to_Python_I.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/17fZGYDQfVE24vxweCp-eqayFnr3lzoOM
...
def first_last(c):
  if len(c) > 0:
    if len(c) > 1:
      return c[0], c[-1]
    return c[0]
  return # Put your return values here.  Remember a function can return two values (you will format your return statement as "return value1, value2").
