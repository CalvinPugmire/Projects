...
Original file is located at
    https://colab.research.google.com/drive/12U4ztTRLteUadGB3WYxPvLk6hSLMImDc
...
def transform(x):
  y = np.array([2*x[0]+x[1], x[0]-3*x[1], x[1]])
  return y
...
comp_matrix=stretch(reflect(rotate(stretch(iden,1,2),-np.pi/4),-2/3,1),.5,1)
...
# Save the values of the determinants of the matrices B1,B3,B6, and B0 from Problem 7.
