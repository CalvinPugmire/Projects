...
Original file is located at
    https://colab.research.google.com/drive/1zdvgKYIEF6Dkncmwe205sQL4EHtNunk8
...
W=(1/(X_total[0,:].size-1))*np.matmul(X_total,np.transpose(X_total))
