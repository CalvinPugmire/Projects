...
Original file is located at
    https://colab.research.google.com/drive/1BLdbsyrzlZfSNR_HtdYZqO_qL_CoCHUE
...
# Construct your plot of ls1_line and the corresponding data points here. 
# Put all of your code to create the plots inside the function below.
...
def create_plots1():
  ...
  plt.plot(x,y)
  plt.plot(a,z,'o',markersize=5,alpha=1)
  plt.show()
  return None
...
pred_Uran=ls3_log(30687.15)

pred_Nept=ls3_log(60190.03)
