...
public class Flight implements Cloneable {
	...
	public String delta(Flight _flight) {
		if (_flight != null) {
			return String.format("lon: %f, lat: %f, vel: %f, alt: %f",
					(longitude - _flight.longitude), (latitude - _flight.latitude), (velocity - _flight.velocity), (geo_altitude - _flight.geo_altitude));
		} else {
			return "lon: 0, lat: 0, vel: 0, alt: 0";
		}
	}
