...
public class EventDAOTest {
    ...
    public void findPass() throws DataAccessException {
        ...
        assertNotNull(compareTest);
        //Now lets make sure that what we put in is exactly the same as what we got out. If this
        //passes then we know that our find found the right event
        assertEquals(bestEvent, compareTest);
    }
    ...
    public void findFail() throws DataAccessException {
        //lets do this test again but this time lets try to make it fail
        //if we clear the database then there will be no events to find
        eDao.clear();
        //searching for an event will cause the method to return null
        Event compareTest = eDao.find(bestEvent.getEventID());
